...
public class Animation {
    ...
    public Animation(){}
    /**
     * Sadece bir adet texture eklenir.
     * @param texture_of_sprit texture
     */
    ...
    /**
     * Animasyon için oluşturduğunuz sıralı TextureRegion dizisini ekleyiniz.
     * @param sprite TextureRegion dizisi
     */
    ...
    /**
     * Anlık olarak çalışmasını istediğiniz animasyonu ekleyebilirsiniz.
     * @param sprite TextureRegion dizisi
     * @return
     */
    public Animation setSprite(TextureRegion[] sprite){
        this.sprite=sprite;
    ...
    public Animation setAllFlibX(boolean flibX){
        System.out.println("flibX 1 "+ sprite[0].isFlipX());
        for(int i=0; i<sprite.length; i++){
            sprite[i].flip(flibX,false);
        }
        System.out.println("flibX 2 "+ sprite[0].isFlipX());
        return this;
    }
    public Animation setOrginalFlibX(){
        for(int i=0; i<sprite.length; i++){
            sprite[i].flip(isLookRight,false);
        }
        return this;
    }
...
//region simdilik isimi görmez fakat frame'ler tek bir görselde birikiyorsa kullanılabilir.
